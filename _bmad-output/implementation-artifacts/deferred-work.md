...
## Deferred from: code review of story 15.0a (2026-04-26)
...
- **Hardcoded CLI params for all SDK roles:** `--allowedTools`, `--max-turns 200`, `--permission-mode acceptEdits` are hardcoded for all roles (dev, review, supervisor). A review role getting write permissions is debatable. Intentional per architecture decision — configurability is future work.
